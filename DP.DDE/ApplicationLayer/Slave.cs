//<summary>
//  Title   : DDE implementation of IApplicationLayerSlave
...
namespace CAS.Lib.CommonBus.ApplicationLayer.DDE
{
  ...
  /// <summary>
  /// DDE implementation of IApplicationLayerSlave
  /// </summary>
  internal class Slave: ApplicationLayerCommon, IApplicationLayerSlave
  {
    #region PRIVATE
