//<summary>
//  Title   : Ec3_3Sym plugin Data Provider inentifier
...
{
  /// <summary>
  /// Ec3_3Sym plugin Data Provider inentifier
  /// </summary>
  public class NULL_DataProviderID: DataProviderID
  {
    ...
    {
      EC2_3SYM_ApplicationLayerPluginHelper m_ApplicationLayerPluginHelper = new EC2_3SYM_ApplicationLayerPluginHelper( pParent );
    ...
    {
      SortedList<short, StartEndPair> StartEndPairs = new SortedList<short, StartEndPair>();
      StartEndPairs.Add( (short)PRIVATE.Medium_T.Flag, new StartEndPair( 0, ItemDefaultSettings.FlagsNames.Length - 1 ) );
      StartEndPairs.Add( (short)PRIVATE.Medium_T.Register, new StartEndPair( 0, ItemDefaultSettings.RegistersNames.Length - 1 ) );
      return GetAvailiableAddressspacesHelper( typeof( PRIVATE.Medium_T ), StartEndPairs );
    }
    /// <summary>
