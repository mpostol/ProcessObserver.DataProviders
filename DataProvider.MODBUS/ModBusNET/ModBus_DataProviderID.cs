...
namespace CAS.Lib.CommonBus.ApplicationLayer.ModBus
{
  ...
  {
    #region private
    private ProtocolParameters m_ProtocolParameters = new ModBus_ProtocolParameters( 9600, 500, 5 );
    #endregion
    #region Settings
    /// <summary>
    ...
    public ProtocolParameters MODBusProtocolParameters
    {
    ...
    {
      ModBus_ApplicationLayerPluginHelper m_ApplicationLayerPluginHelper = new ModBus_ApplicationLayerPluginHelper( pParent );
