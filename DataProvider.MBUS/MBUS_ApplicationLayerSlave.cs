...
namespace CAS.Lib.CommonBus.ApplicationLayer.MBUS
{
  ...
  /// 
  /// </summary>
  internal class MBUS_ApplicationLayerSlave: ApplicationLayerCommon, IApplicationLayerSlave
  {
    //private IProtocolParent myStatistic = null;
    ////    private class MBUS_buf_pool: CAPI.Session.SesDBufferPool
    //    {
    ...
    //          }
    //        }//end while
    //        if(Rxmsg.CheckRequestFrame()== MBUS_Exceptions.OK) res = BaseStation.RX_Res_T.RX_OK;
    ...
    //    }//RX_TELEGRAM
    //
    internal MBUS_ApplicationLayerSlave( ICommunicationLayer cCommChannel )
      : base( cCommChannel )
    {
      //      pool = new MBUS_buf_pool();
    }
    ...
    AL_ReadData_Result IApplicationLayerSlave.ReadCMD( out IReadCMDValue frame )
    {
      ...
      //      bool ret;
      //      MBUS_message MBUS_frame;
      //      frame=null;
      //      RX_Res_T res = RX_TELEGRAM(port, out MBUS_frame, false);
      //      if(res==RX_Res_T.RX_OK)
      //      {
      //        switch(MBUS_frame.dataType)
      //        {
      //          case 0:
      //            cmd = (BaseStation.ProtocolCmd)BaseStation.MBUS_Functions.ERORR;
      //            break;
      //          case 1:
      //            cmd = (BaseStation.ProtocolCmd)BaseStation.MBUS_Functions.READ_COILS;
      //            break;
      //          case 3:
      //            cmd = (BaseStation.ProtocolCmd)BaseStation.MBUS_Functions.READ_MULTIPLE_REGISTERS;
      //            break;
      //          case 5:
      //            cmd = (BaseStation.ProtocolCmd)BaseStation.MBUS_Functions.WRITE_SINGLE_COIL;
      //            break;
      //          case 6:
      //            cmd = (BaseStation.ProtocolCmd)BaseStation.MBUS_Functions.WRITE_SINGLE_REGISTER;
      //            break;
      //          default:
    ...
    //      return false;
    //    }
    //dla MBUSa do tworzenia ramki odpowiedzi na ¿¹danie pisania
    internal bool SendACKRes( MBUS_message oldframe )
    {
