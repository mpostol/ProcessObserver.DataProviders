...
namespace CAS.CommServer.DataProvider.Scripts
{
  ...
  public class CreateTagPrototyping
  {
    ...
    public void CreateTagTest()
    {
      ...
      string _solutionPath = @"/CommServer.DataProvider";
      string _trunkPath = $@"{_repositoryUrl}trunk{_solutionPath}/";
      string _tagPath = $@"{_repositoryUrl}tags{_solutionPath}.rel_{_rel}";
      #endregion

      Assert.AreEqual("svn://svnserver.hq.cas.com.pl/VS/trunk/CommServer.DataProvider/", _trunkPath);
      Assert.AreEqual("svn://svnserver.hq.cas.com.pl/VS/tags/CommServer.DataProvider.rel_2_01_1061", _tagPath);
